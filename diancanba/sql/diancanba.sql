SET NAMES 'utf8';
DROP DATABASE IF EXISTS diancanba;
CREATE DATABASE diancanba CHARSET=UTF8;
USE diancanba;
...
CREATE TABLE dc_dish(
    ...
    material VARCHAR(2048) NOT NULL DEFAULT ''
);
INSERT INTO dc_dish(did,img_sm,img_lg,name,price,material,detail) VALUES
(   null,
    'p0281.jpg',
    'p0281-l.jpg',
    '【酸甜开胃虾】',
...
CREATE TABLE dc_order(
    ...
    sex INT NOT NULL DEFAULT 0,    /*1:男  2:女*/
    order_time DATETIME NOT NULL DEFAULT 0,
    addr VARCHAR(256) NOT NULL DEFAULT '',
    did INT NOT NULL DEFAULT 0
);
INSERT INTO dc_order(oid, phone,user_name,sex,order_time,addr,did) VALUES
(NULL,'13501234567','婷婷',2,1445154859209,'大钟寺中鼎B座',3),
(NULL,'13013683292','Leo',2,1445254959209,'德基广场',2),
(NULL,'13865258887','旭旭',2,1445354959209,'崇安寺25号',5);
